...
struct ResetPwdView: View {
    ...
    @StateObject private var model = ResetPwdViewModel()
                    ...
                    VStack {
                        HStack {
                            if model.isSecured {
                                ...
                                TextField("New Password", text: $model.password)
                                    .padding(EdgeInsets(top: 8, leading: 10, bottom: 8, trailing: 10))
                                    .font(.system(size: 17))
                                    .foregroundColor(.appPrimary)
                                    .tint(.appPrimary)
                        ...
                        .padding(.top, 20)
                        .disabled(model.password.isEmpty || model.confirmPwd.isEmpty)
...
struct ResetPwdView_Previews: PreviewProvider {
    static var previews: some View {
        ResetPwdView(email: "bright.sun667@gmail.com")
    }
}
